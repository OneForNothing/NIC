...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_addgroup_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 34, 21)
    ...
    "addgroup\0on_pushButton_2_clicked\0\0"
...
const QMetaObject addgroup::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_addgroup.data,
      qt_meta_data_addgroup,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_addgroup.stringdata))
