...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_registerMainWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 76, 3),
QT_MOC_LITERAL(6, 80, 13)
    },
    "registerMainWindow\0on_pushButton_clicked\0"
    "\0deelMessage\0QMap<QString,QString>\0"
    "msg\0TypeOfMessage\0"
};
...
void registerMainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->deelMessage((*reinterpret_cast< QMap<QString,QString>(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
const QMetaObject registerMainWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_registerMainWindow.data,
      qt_meta_data_registerMainWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_registerMainWindow.stringdata))
        return static_cast<void*>(const_cast< registerMainWindow*>(this));
