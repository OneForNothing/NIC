...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ShowCPUMemory_t, stringdata) + ofs \
...
const QMetaObject ShowCPUMemory::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ShowCPUMemory.data,
      qt_meta_data_ShowCPUMemory,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ShowCPUMemory.stringdata))
