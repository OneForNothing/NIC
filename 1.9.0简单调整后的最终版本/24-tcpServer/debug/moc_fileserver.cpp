...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_fileserver_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 92, 11)
    ...
    "fileserver\0acceptConnection\0\0"
...
const QMetaObject fileserver::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_fileserver.data,
      qt_meta_data_fileserver,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_fileserver.stringdata))
